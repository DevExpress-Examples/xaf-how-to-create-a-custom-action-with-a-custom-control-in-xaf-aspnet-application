...
#End If
        ...
        Protected Sub Session_Start(ByVal sender As Object, ByVal e As EventArgs)
            Call WebApplication.SetInstance(Session, New Solution28AspNetApplication())
#If EASYTEST
			if(ConfigurationManager.ConnectionStrings["EasyTestConnectionString"] != null) {
				WebApplication.Instance.ConnectionString = ConfigurationManager.ConnectionStrings["EasyTestConnectionString"].ConnectionString;
			}
#End If
            WebApplication.Instance.ConnectionString = E2813.Demo.Web.CodeCentralExampleInMemoryDataStoreProvider.ConnectionString
            If ConfigurationManager.ConnectionStrings("ConnectionString") IsNot Nothing Then
                WebApplication.Instance.ConnectionString = ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString
            End If

            WebApplication.Instance.Settings.DefaultTemplateContentPath = "DefaultTemplateContent1.ascx"
