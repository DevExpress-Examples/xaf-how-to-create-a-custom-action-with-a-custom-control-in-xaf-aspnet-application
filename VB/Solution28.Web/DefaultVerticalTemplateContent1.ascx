<%@ Control Language="vb" CodeBehind="DefaultVerticalTemplateContent1.ascx.vb" ClassName="DefaultVerticalTemplateContent1"
	CompilationMode="Auto" Inherits="Solution28.Web.DefaultVerticalTemplateContent1" AutoEventWireup="True" %>
<%@ Register Assembly="DevExpress.Web.v12.2" Namespace="DevExpress.Web.ASPxRoundPanel"
	TagPrefix="dxrp" %>
...
<%@ Register Assembly="DevExpress.Web.v12.2" Namespace="DevExpress.Web.ASPxPanel"
	TagPrefix="dxrp" %>
<%@ Register Assembly="DevExpress.Web.v12.2" Namespace="DevExpress.Web.ASPxSplitter"
	TagPrefix="dx" %>
<%@ Register Assembly="DevExpress.Web.v12.2" Namespace="DevExpress.Web.ASPxGlobalEvents"
	TagPrefix="dxge" %>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="Top" width="100%">
								<tr>
									...
									<td class="Security">
										...
										<ccmy:MyActionContainerHolder runat="server" ID="SAC" CssClass="Security" Categories="Security"
								...
								<tr class="Content">
									<td class="Content WithPaddings" align="right">
										<cc3:XafUpdatePanel ID="UPSHC" runat="server">
											<ccmy:MyActionContainerHolder ID="SHC" runat="server" Categories="RootObjectsCreation;Appearance;Search;FullTextSearch"
											...
											<dxrp:ASPxRoundPanel ID="TRP" runat="server" HeaderText="Tools" CssClass="TRP">
												<PanelCollection>
													<dxrp:PanelContent ID="PanelContent1" runat="server">
														<ccmy:MyActionContainerHolder ID="VTC" runat="server" Menu-Width="100%" Categories="Tools"
