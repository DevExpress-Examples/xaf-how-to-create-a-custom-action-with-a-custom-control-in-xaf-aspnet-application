...
Namespace Solution28.Web
    ...
    Public Partial Class DefaultTemplateContent1
        Inherits TemplateContent

        Protected Overrides Sub OnLoad(ByVal e As EventArgs)
            MyBase.OnLoad(e)
            If WebWindow.CurrentRequestWindow IsNot Nothing Then
                AddHandler WebWindow.CurrentRequestWindow.PagePreRender, New EventHandler(AddressOf CurrentRequestWindow_PagePreRender)
            End If
        End Sub

        Protected Overrides Sub OnUnload(ByVal e As EventArgs)
            If WebWindow.CurrentRequestWindow IsNot Nothing Then
                RemoveHandler WebWindow.CurrentRequestWindow.PagePreRender, New EventHandler(AddressOf CurrentRequestWindow_PagePreRender)
            End If
